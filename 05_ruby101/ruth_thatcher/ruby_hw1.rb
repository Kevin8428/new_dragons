...
# def wordReverse(string)
  # p "Now I know what a TV dinner feels like"
...
#use sort with a.length or b.length; create array by sorting by length and create new array

def longest_word(array)
  p arr = arr.sort_by(&:length)
 end
p longest_word(return last index!)
